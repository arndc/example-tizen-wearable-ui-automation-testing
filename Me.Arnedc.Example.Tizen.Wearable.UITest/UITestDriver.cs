...
{
    public sealed class UITestDriver
    {
        const int DelayTime = DriverConfig.DEFAULT_DELAY_TIME;
        ...
        public static UITestDriver Instance
        {
            get
            {
                if (_instance == null)
                {
                    _instance = new UITestDriver(DriverConfig.PLATFORM, "");
                }
                return _instance;
            }
        }
        ...
        public void FindTC(string testName)
        {
            ...
            while (true)
            {
                IReadOnlyCollection<AppiumWebElement> resultByAccessibilityId = _driver.FindElementsByAccessibilityId(testName);
                ...
                {
                    TizenElement element = _driver.FindElementByAccessibilityId(testName) as TizenElement;
                    if (element != null)
                    {
                        element.Click();
                        System.Threading.Thread.Sleep(1000);
                        ...
                        IReadOnlyCollection<AppiumWebElement> resultByAccessibilityId2 = _driver.FindElementsByAccessibilityId(testName);
